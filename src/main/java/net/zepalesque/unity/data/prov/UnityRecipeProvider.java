...
public abstract class UnityRecipeProvider extends AetherRecipeProvider {
    ...
    public static void brick(RecipeOutput recipeOutput, RecipeCategory category,
                             ItemLike brick, ItemLike base) {
    ...
    public void craftStoneSet(RecipeOutput output, RecipeCategory category,
                              ItemLike base, ItemLike wall, ItemLike stairs, ItemLike slab) {
    ...
    public void stonecutStoneSet(RecipeOutput output, RecipeCategory category,
                                 ItemLike base, ItemLike wall, ItemLike stairs, ItemLike slab) {
    ...
    public void stonecutAndCraftStoneSet(RecipeOutput output, RecipeCategory category,
                                         ItemLike base, ItemLike wall, ItemLike stairs, ItemLike slab) {
    ...
    protected void stonecut(RecipeOutput output,
                            RecipeCategory category,
                            ItemLike item,
                            ItemLike ingredient,
                            int count) {
        SingleItemRecipeBuilder.stonecutting(
            Ingredient.of(ingredient), category, item, count
        ).unlockedBy(getHasName(ingredient), has(ingredient)).save(
            output, name(getConversionRecipeName(item, ingredient) + "_stonecutting")
        );
    }
