...
public class UnityRegistrySets extends DatapackBuiltinEntriesProvider {
    ...
    public UnityRegistrySets(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, String... otherIds) {
        super(output, registries, BUILDER, buildModidList(Unity.MODID, otherIds));
    }
