...
public abstract class UnitySoundsProvider extends SoundDefinitionsProvider {
    protected UnitySoundsProvider(PackOutput output, String modId, ExistingFileHelper helper) {
